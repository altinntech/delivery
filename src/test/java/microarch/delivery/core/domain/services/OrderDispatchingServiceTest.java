...
public class OrderDispatchingServiceTest {
    ...
    public void shouldDispatchOrder() {
        ...
        Courier courier1 = Courier.create("Bob", Speed.create(2).getValue(), Location.create(1, 1).getValue()).getValue();
        Courier courier2 = Courier.create("Tom", Speed.create(1).getValue(), Location.create(1, 1).getValue()).getValue();
        Courier courier3 = Courier.create("Bill", Speed.create(3).getValue(), Location.create(1, 1).getValue()).getValue();
